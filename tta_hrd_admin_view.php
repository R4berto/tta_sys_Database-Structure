...
$sql1 = "SELECT id,first_name, middle_name, last_name, suf, gen, dob, cs, rg, n,
 sn, pa_address, ca_address, pa_contact, pa_email, pa_facebook, pa_instagram,
  fn, mn, ps, py, pa, ss, sy, sa, ts, ty, ta, noe, doe, cn, fp, dor FROM index1";
$sql2 = "SELECT id,sss, pb, ph, umid, nd, dl, pp, pt FROM index2";
$sql3 = "SELECT id,pos, d, w, m, sa, doe FROM index3";
...
<html>
<head>
    <title>Admin Human Resources Database</title>
    <style>
        body {
...
<h1>
	...
	<h2>
        ...
        $conn->close();
        ?>
        <a href="tta_hrd_admin_index1.php" class="btn">New Entry</a>
